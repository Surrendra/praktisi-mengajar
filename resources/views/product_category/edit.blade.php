...
@section('content')
<form class="card" action="{!! route('product_categories.update',$product_category->id) !!}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="card-body">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <textarea name="description" id="description" class="form-control" cols="30" rows="10">{!! $product_category->description !!}</textarea>
            </div>
        </div>
    </div>
